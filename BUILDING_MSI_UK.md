...
У цьому репо також додано виправлення, яке не передає властивості `AppendTargetFrameworkToOutputPath` у `ProjectReference`, щоб залежності з multi-target (зокрема 7zip/ZedGraph) збирались у правильні шляхи.
